package com.hrpms.service.business_menu_service.customer_client_service.impl;

import com.hrpms.dao.business_menu_dao.customer_client_dao.CustomerDao;
import com.hrpms.pojo.*;
import com.hrpms.pojo.operaton_select.TbCustomerOperation;
import com.hrpms.service.business_menu_service.company_client_service.CompanyClientService;
...
import com.hrpms.service.business_menu_service.shebao_manager_service.SheBaoService;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    public List<TbCustomer> selectAllCustomerName(String name) {
        StringBuffer sql = new StringBuffer("from TbCustomer where 1=1 ");
        if(name.equals("isSalary")){
            sql.append("and isSalary = 0 ");
        }
        if(name.equals("isGongjijin")){
            sql.append("and isGongjijin = 0 ");
        }
        sql.append("and status=0 ");
        return customerDao.selectAllCustomerName(sql.toString());
    }
