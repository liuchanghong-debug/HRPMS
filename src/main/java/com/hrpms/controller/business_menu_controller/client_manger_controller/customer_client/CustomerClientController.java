package com.hrpms.controller.business_menu_controller.client_manger_controller.customer_client;
...
public class CustomerClientController {
    ...
    public List<TbCustomer> selectAllCustomerName(String name){
        List<TbCustomer> list = customerService.selectAllCustomerName(name);
        return list;
    }
