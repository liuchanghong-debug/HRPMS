package com.hrpms.controller.business_menu_controller.salary_manager_controller;
...
public class TbSalaryController {
    ...
    //根据姓名查询所有
    @RequestMapping("/selectSalaryByName")
    @ResponseBody
    public TbSalary selectSalaryByName(String name){
        TbSalary salary = tbSalaryService.selectSalaryByName(name);
        return salary;
    }
