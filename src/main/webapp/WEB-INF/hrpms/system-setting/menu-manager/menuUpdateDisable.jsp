...
%>
		...
		<li class="active"><a href="saved_resource_unEdit.html">菜单修改</a></li>
		</ul><br>
		...
		<div class="controls">
		<input id="funcname" name="funcname" class="input-xlarge required" type="text" value="系统设置" maxlength="50" disabled="disabled">
		...
		<select id="functype" name="functype"  class="select2-offscreen"  disabled="disabled">
