...
<base href="<%=basePath%>">
<!DOCTYPE html>
<!-- saved from url=(0051)http://localhost:8080/jeesite/a/company/messageInfo -->
...
<form id="searchForm" class="breadcrumb form-search" action="#" method="post">
	...
	<ul class="ul-form">
		<li><label>标题：</label>
			<input id="title" name="title" class="input-medium" type="text" value="" maxlength="50">
		</li>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
	...
	<tr>
		<td><a href="../updateMessage/saved_resource_unEdit.html">
			1
		</a></td>
		<td>
			您好，java培训是怎么收费的？
		...
		<td>
			<a href="../updateMessage/saved_resource.html">修改</a>
			<a href="../updateReplay/saved_resource.html">回复</a>
			<a href="#" onclick="return confirmx(&#39;确认要删除该留言吗？&#39;, this.href)">删除</a>
		</td>
	</tr>
