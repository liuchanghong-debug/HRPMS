...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="saved_resource_unEdit.html">新闻修改</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="newstitle" name="newstitle" class="input-xlarge required" type="text" value="特朗普访华" maxlength="128" disabled="disabled">
	...
	特朗普访华，习近平夫妇天安门口迎接，一块去故宫。&amp;lt;/p&amp;gt;</textarea>
			...
			<script type="text/javascript">
                ...
                CKEDITOR.on('instanceReady', function (ev) {
                    contentCkeditor = ev.editor;
                    contentCkeditor.setReadOnly(true);
                });
			</script>
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="remark" name="remark" class="input-xlarge " type="text" value="测试" maxlength="256" disabled="disabled">
		</div>
	</div>
