...
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="messageid" name="messageid" class="input-xlarge required" type="text" value="1" maxlength="11">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea id="content" name="content" class="input-xxlarge required" rows="4">您好，方便留下您的手机号码吗，我们会直接联系您的？</textarea>
			<span class="help-inline"><font color="red">*</font> </span>
		</div>
	</div>
	<!-- 		<div class="control-group"> -->
