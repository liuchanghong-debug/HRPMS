...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="saved_resource.html">公司客户修改</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<table class="table table-bordered table-condensed">
		<tbody><tr>
			...
			<td>
				<input id="name" name="name" class="input-xlarge required" type="text" value="智递科技有限公司" maxlength="100">
			...
			<td>
				<input id="companyno" name="companyno" class="input-xlarge " type="text" value="4101000011118888" maxlength="20">
			</td>
		</tr>
		<tr>
			<td><label class="control-label">电话：</label></td>
			<td><input id="telphone" name="telphone" class="input-xlarge " type="text" value="0371-66668888" maxlength="13"></td>
		...
		<tr>
			...
			<td><input id="owner" name="owner" class="input-xlarge " type="text" value="肖俊" maxlength="30"></td>
			<td><label class="control-label">身份证号：</label></td>
			<td><input id="idcard" name="idcard" class="input-xlarge " type="text" value="430121198412122818" maxlength="20"></td>
		</tr>

		<tr>
			<td><label class="control-label">手机：</label></td>
			<td><input id="phone" name="phone" class="input-xlarge " type="text" value="13899998888" maxlength="13"></td>
			<td><label class="control-label">性别：</label></td>
			<td><input id="sex" name="sex" class="input-xlarge " type="text" value="男" maxlength="2"></td>
		</tr>

		<tr>
			<td><label class="control-label">电子邮件：</label></td>
			<td><input id="email" name="email" class="input-xlarge " type="text" value="xiaojun@zhidisoft.com" maxlength="50"></td>
			<td><label class="control-label">公司性质：</label></td>
			<td><input id="ownership" name="ownership" class="input-xlarge " type="text" value="私有股份制公司" maxlength="150"></td>
		</tr>
		...
		<tr>
			...
			<td colspan="3"><textarea id="address" name="address" maxlength="256" class="input-xxlarge " rows="3">硅谷广场A座</textarea></td>
		</tr>

		<tr>
			<td><label class="control-label">备注：</label></td>
			<td colspan="3"><textarea id="remark" name="remark" maxlength="512" class="input-xxlarge " rows="3">信誉良好公司</textarea></td>
		</tr>
