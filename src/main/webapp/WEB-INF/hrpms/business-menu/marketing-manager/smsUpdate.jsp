...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="saved_resource.html">短信修改</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="userId" name="userId" class="input-xlarge required" type="text" value="1000" maxlength="512">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">接收人电话：</label>
		<div class="controls">
			<input id="telephone" name="telephone" class="input-xlarge required" type="text" value="15800008888" maxlength="512">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea id="content" name="content" class="input-xxlarge required" rows="4">你好，今天是您的生日，主您生日快乐</textarea>
			<span class="help-inline"><font color="red">*</font> </span>
		</div>
	</div>
	<!-- 		<div class="control-group"> -->
