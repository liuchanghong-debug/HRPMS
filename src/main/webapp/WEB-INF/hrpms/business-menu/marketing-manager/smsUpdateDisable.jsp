...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="saved_resource_unEdit.html">短信修改</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input id="userId" name="userId" class="input-xlarge required" type="text" value="1000" maxlength="512" disabled="disabled">
		</div>
	</div>
	<div class="control-group">
		<label class="control-label">接收人电话：</label>
		<div class="controls">
			<input id="telephone" name="telephone" class="input-xlarge required" type="text" value="15800008888" maxlength="512" disabled="disabled">
	...
	<div class="form-actions">
		<input id="btnSubmit" class="btn btn-primary" type="submit" value="发送" disabled="disabled">&nbsp;
