...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="saved_resource.html">社保信息添加</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<table>
		...
		<tr>
			...
			<td>
				<select name="companyid" class="input-xlarge  select2-offscreen" tabindex="-1">
		...
		<tr>
			...
			<td><input id="sbcard" name="sbcard" class="input-xlarge " type="text" value="" maxlength="20"></td>
			<td><label class="control-label">缴费基数：</label></td>
			<td><input id="basepay" name="basepay" class="input-xlarge " type="text" value=""></td>
		</tr>

		<tr>
			<td><label class="control-label">应缴金额：</label></td>
			<td><input id="mustpay" name="mustpay" class="input-xlarge " type="text" value=""></td>
			<td><label class="control-label">个人比率：</label></td>
			<td><input id="personratio" name="personratio" class="input-xlarge " type="text" value="" maxlength="5"></td>
		</tr>

		<tr>
			<td><label class="control-label">单位比率：</label></td>
			<td><input id="companyratio" name="companyratio" class="input-xlarge " type="text" value="" maxlength="5"></td>
		...
		<tr>
			...
			<td>
				<input name="paydate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate " value="" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});">
			</td>
			<td><label class="control-label">代理费用：</label></td>
			<td><input id="proxyfee" name="proxyfee" class="input-xlarge " type="text" value=""></td>
		</tr>
		...
		<tr>
			...
			<td><input id="remark" name="remark" class="input-xlarge " type="text" value="" maxlength="512"></td>
		</tr>
		</tbody></table>
