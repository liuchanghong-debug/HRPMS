...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="saved_resource.html">社保信息修改</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<table>
		...
		<tr>
			...
			<td><input type="text" name="phone" maxlength="13" class="input-xlarge "></td>
			<td><label class="control-label">电子邮件：</label></td>
			<td><input type="text" name="email" maxlength="50" class="input-xlarge "></td>
		</tr>
		<tr>
			<td><label class="control-label">现在住址：</label></td>
			<td><input type="text" name="address" maxlength="100" class="input-xlarge "></td>
			<td><label class="control-label">邮政编码：</label></td>
			<td><input type="text" name="zipcode" maxlength="20" class="input-xlarge "></td>
		</tr>

		<tr>
			<td><label class="control-label">毕业学校：</label></td>
			<td><input type="text" name="school" maxlength="20" class="input-xlarge "></td>
			<td><label class="control-label">所学专业：</label></td>
			<td><input type="text" name="specialty" maxlength="20" class="input-xlarge "></td>
		</tr>

		<tr>
			<td><label class="control-label">毕业时间：</label></td>
			<td><input type="text" name="graduation" maxlength="20" class="input-xlarge "></td>
			<td><label class="control-label">所属公司：</label></td>
			<td>
				<select name="companyid" class="input-xlarge" >
					<option value="">
					</option><option value="">智递科技有限公司
				</option></select>
			</td>
		</tr>
		...
		<tr>
			...
			<td><input id="sbcard" name="sbcard" class="input-xlarge " type="text" value="1000047" maxlength="20"></td>
			<td><label class="control-label">缴费基数：</label></td>
			<td><input id="basepay" name="basepay" class="input-xlarge " type="text" value="5000"></td>
		</tr>

		<tr>
			<td><label class="control-label">应缴金额：</label></td>
			<td><input id="mustpay" name="mustpay" class="input-xlarge " type="text" value="870"></td>
			<td><label class="control-label">个人比率：</label></td>
			<td><input id="personratio" name="personratio" class="input-xlarge " type="text" value="20%" maxlength="5"></td>
		</tr>

		<tr>
			<td><label class="control-label">单位比率：</label></td>
			<td><input id="companyratio" name="companyratio" class="input-xlarge " type="text" value="80%" maxlength="5"></td>
		...
		<tr>
			...
			<td>
				<input name="paydate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate " value="2017-10-26 00:00:00" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});">
			</td>
			<td><label class="control-label">代理费用：</label></td>
			<td><input id="proxyfee" name="proxyfee" class="input-xlarge " type="text" value="75"></td>
		</tr>
		...
		<tr>
			...
			<td><input id="remark" name="remark" class="input-xlarge " type="text" value="test" maxlength="512"></td>
		</tr>
		</tbody></table>
