...
<ul class="nav nav-tabs">
	...
	<li class="active"><a href="shebao/shebaoShow?id=${socialInsurance.id}">社保信息查看</a></li>
</ul><br>
<form id="inputForm" class="form-horizontal" action="#" method="post" novalidate="novalidate">
	...
	<table>
		<tbody><tr>
			...
			<td>
				<input type="text" id="customer_name" name="customerName" value="${customer.name}" onblur="getCustomerByName();" style="width:270px;" disabled="disabled">
			</td>
		...
		<tr>
			...
			<td><input id="sbcard" name="sbcard" class="input-xlarge " type="text" value="${socialInsurance.sbCard}" maxlength="20" disabled="disabled"></td>
			<td><label class="control-label">缴费基数：</label></td>
			<td><input id="basepay" name="basepay" class="input-xlarge " type="text" value="${socialInsurance.basePay}" disabled="disabled"></td>
		</tr>

		<tr>
			<td><label class="control-label">应缴金额：</label></td>
			<td><input id="mustpay" name="mustpay" class="input-xlarge " type="text" value="${socialInsurance.mustPay}" disabled="disabled"></td>
			<td><label class="control-label">个人比率：</label></td>
			<td><input id="personratio" name="personratio" class="input-xlarge " type="text" value="${socialInsurance.personRatio}" maxlength="5" disabled="disabled"></td>
		</tr>

		<tr>
			<td><label class="control-label">单位比率：</label></td>
			<td><input id="companyratio" name="companyratio" class="input-xlarge " type="text" value="${socialInsurance.companyRatio}" maxlength="5" disabled="disabled"></td>
			<td><label class="control-label">养老保险：</label></td>
			<td><input id="yanglao" name="yanglao" class="input-xlarge " type="text" value="${socialInsurance.yangLao}" disabled="disabled"></td>
		</tr>
		<tr>
			<td><label class="control-label">医疗保险：</label></td>
			<td><input id="yiliao" name="yiliao" class="input-xlarge " type="text" value="${socialInsurance.yiLiao}" disabled="disabled"></td>
			<td><label class="control-label">工伤保险：</label></td>
			<td><input id="gongshang" name="gongshang" class="input-xlarge " type="text" value="${socialInsurance.gongShang}" disabled="disabled"></td>
		</tr>

		<tr>
			<td><label class="control-label">失业保险：</label></td>
			<td><input id="shiye" name="shiye" class="input-xlarge " type="text" value="${socialInsurance.shiYe}" disabled="disabled"></td>
			<td><label class="control-label">生育保险：</label></td>
			<td><input id="shengyu" name="shengyu" class="input-xlarge " type="text" value="${socialInsurance.shengYu}" disabled="disabled"></td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<input name="paydate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate " value="${payTime}" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-dd HH:mm:ss&#39;,isShowClear:false});" disabled="disabled">
			</td>
			<td><label class="control-label">代理费用：</label></td>
			<td><input id="proxyfee" name="proxyfee" class="input-xlarge " type="text" value="${socialInsurance.proxyFee}" disabled="disabled"></td>
		</tr>
		...
		<tr>
			...
			<td><input id="remark" name="remark" class="input-xlarge " type="text" value="${socialInsurance.remark}" maxlength="512" disabled="disabled"></td>
		</tr>
		</tbody>
	</table>
